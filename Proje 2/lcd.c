...
void lcd_ilkAyarlar()
{
    ...
    HWREGBITW(SYSCTL_RCGCBASE + ((SYSCTL_PERIPH_GPIOB & 0xff00) >> 8),SYSCTL_PERIPH_GPIOB & 0xff) = 1;  // SYSCTL_RCGCGPIO_R |= 0x02;
...
{
    HWREG(LCD_PORT + (GPIO_O_DATA + (D4|D5|D6|D7 << 2))) = (b & 0xf0);
    HWREG(LCD_PORT + (GPIO_O_DATA + (RS << 2))) = 0x00;
    HWREG(LCD_PORT + (GPIO_O_DATA + (E << 2))) = 0x02;
    SysCtlDelay(10);
    HWREG(LCD_PORT + (GPIO_O_DATA + (E << 2))) = 0x00;
    ...
    HWREG(LCD_PORT + (GPIO_O_DATA + (D4|D5|D6|D7 << 2))) = ((b & 0x0f) << 4 );
    HWREG(LCD_PORT + (GPIO_O_DATA + (RS << 2))) = 0x00;
    HWREG(LCD_PORT + (GPIO_O_DATA + (E << 2))) = 0x02;
    SysCtlDelay(10);
    HWREG(LCD_PORT + (GPIO_O_DATA + (E << 2))) = 0x00;
...
{
    HWREG(LCD_PORT + (GPIO_O_DATA + (D4|D5|D6|D7 << 2))) = (c & 0xf0);
    ...
    HWREG(LCD_PORT + (GPIO_O_DATA + (D4|D5|D6|D7 << 2))) = ((c & 0x0f) << 4 );
    HWREG(LCD_PORT + (GPIO_O_DATA + (RS << 2))) = 0x01;
    HWREG(LCD_PORT + (GPIO_O_DATA + (E << 2))) = 0x02;
    SysCtlDelay(10);
    HWREG(LCD_PORT + (GPIO_O_DATA + (E << 2))) = 0x00;
